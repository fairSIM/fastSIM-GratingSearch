...
# This fetches the 1.4.0 version of fairSIM this is currently compiled against
if [ ! -e fairSIM_plugin.jar ] ; then
    fileMissing=1
    wget https://github.com/fairSIM/fairSIM/releases/download/v1.4.0/fairSIM_plugin.jar
fi
